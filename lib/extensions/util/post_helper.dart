...
class PostHelper {
  ...
  static PopupMenuButton mediaButtons(BuildContext context, PostModel? postModel, String memberID) {
        ...
        onSelected: (choice) {
          if (choice == 0) {
            AbstractStoragePlatform.platform!.takeMedium(
                context,
                postModel!.appId!,
                    (value) => _photoAvailable(postModel, value),
                memberID,
