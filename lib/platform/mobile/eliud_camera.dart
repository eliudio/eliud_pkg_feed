...
class EliudCamera extends StatefulWidget {
  ...
  static void _myVideoError(
      BuildContext context, String error, VideoError passToMe) {
    Navigator.pop(context);
    passToMe(error);
  }
...
class _EliudCameraState extends State<EliudCamera>
...
*/
    if (e.description == null) {
      widget.videoError('Unknown error');
    } else {
