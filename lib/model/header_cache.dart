...
class HeaderCache implements HeaderRepository {

  final HeaderRepository reference;
  final Map<String?, HeaderModel?> fullCache = Map();

  HeaderCache(this.reference);
  ...
  @override
  StreamSubscription<List<HeaderModel?>> listen(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<List<HeaderModel?>> listenWithDetails(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
