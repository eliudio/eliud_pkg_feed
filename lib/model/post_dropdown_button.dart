...
typedef PostChanged(String? value, int? privilegeLevel,);
...
class PostDropdownButtonWidget extends StatefulWidget {
  ...
  PostDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PostDropdownButtonWidgetState();
  }
}
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'posts', widget.value, (newValue, _) {
                  setState(() {
