...
class FeedFrontCache implements FeedFrontRepository {
  ...
  final Map<String?, FeedFrontModel?> fullCache = Map();
  ...
  @override
  Future<FeedFrontEntity?> getEntity(String? id, {Function(Exception p1)? onError}) {
  ...
  @override
  StreamSubscription<List<FeedFrontModel?>> listen(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
    return reference.listen(trigger, orderBy: orderBy, descending: descending, startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery);
  }

  @override
  StreamSubscription<List<FeedFrontModel?>> listenWithDetails(trigger, {String? orderBy, bool? descending, Object? startAfter, int? limit, int? privilegeLevel, EliudQuery? eliudQuery}) {
