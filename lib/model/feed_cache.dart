...
class FeedCache implements FeedRepository {
  ...
  @override
  StreamSubscription<List<FeedModel>> listen(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<FeedModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, int privilegeLevel}) {
