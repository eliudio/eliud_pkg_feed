...
class FeedCache implements FeedRepository {
  ...
  @override
  StreamSubscription<List<FeedModel>> listen(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
  ...
  @override
  StreamSubscription<List<FeedModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
