...
typedef FeedChanged(String value);
...
class FeedDropdownButtonWidget extends StatefulWidget {
  ...
  FeedDropdownButtonWidget({ this.value, this.trigger, this.optional, Key key }): super(key: key);
...
List<Widget> widgets(FeedModel pm) {
