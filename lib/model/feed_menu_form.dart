    ...
    if (formAction == FormAction.ShowData) {
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update FeedMenu", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add FeedMenu", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                ),
      ...
      if (state is FeedMenuFormInitialized) {
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is DocumentIDFeedMenuFormError ? state.message : null;
                  },
                ),
          );
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is AppIdFeedMenuFormError ? state.message : null;
                  },
                ),
          );
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is DescriptionFeedMenuFormError ? state.message : null;
                  },
                ),
          );
