...
class MemberProfileForm extends StatelessWidget {
  ...
  MemberProfileForm({Key? key, required this.app, required this.formAction, required this.value, this.submitAction}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      return BlocProvider<MemberProfileFormBloc >(
        ...
        child: MyMemberProfileForm(app:app, submitAction: submitAction, formAction: formAction),
          );
      ...
      return Scaffold(
        appBar: StyleRegistry.registry().styleWithApp(app).adminFormStyle().appBarWithString(app, context, title: formAction == FormAction.UpdateAction ? 'Update MemberProfile' : 'Add MemberProfile'),
...
class MyMemberProfileForm extends StatefulWidget {
  ...
  MyMemberProfileForm({required this.app, this.formAction, this.submitAction});
