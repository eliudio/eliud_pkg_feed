...
typedef FeedFrontChanged(String? value, int? privilegeLevel,);
...
class FeedFrontDropdownButtonWidget extends StatefulWidget {
  ...
  FeedFrontDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FeedFrontDropdownButtonWidgetState();
  }
}

class FeedFrontDropdownButtonWidgetState extends State<FeedFrontDropdownButtonWidget> {
  FeedFrontListBloc? bloc;

  FeedFrontDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'feedFronts', widget.value, (newValue, _) {
                  setState(() {
