...
typedef FeedFrontChanged(String? value);
...
class FeedFrontDropdownButtonWidget extends StatefulWidget {
  ...
  FeedFrontDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
