...
import 'header_list_bloc.dart';
import 'header_list_event.dart';
import 'header_list_state.dart';
import 'header_model.dart';

class HeaderComponentSelector extends ComponentSelector {
  @override
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<HeaderListBloc>(
      ...
      child: SelectHeaderWidget(app: app,
          height: height,
...
class SelectHeaderWidget extends StatefulWidget {
  final AppModel app;
  final double height;
  ...
  @override
  _SelectHeaderWidgetState createState() {
    return _SelectHeaderWidgetState();
  }
}

class _SelectHeaderWidgetState extends State<SelectHeaderWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<HeaderListBloc>(context).add(
            HeaderChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }

  Widget theList(BuildContext context, List<HeaderModel?> values) {
    var app = widget.app; 
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<HeaderListBloc, HeaderListState>(
      ...
      if ((state is HeaderListLoaded) && (state.values != null)) {
