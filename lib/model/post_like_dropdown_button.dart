...
typedef PostLikeChanged(String? value, int? privilegeLevel,);
...
class PostLikeDropdownButtonWidget extends StatefulWidget {
  ...
  PostLikeDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'postLikes', widget.value, (newValue, _) {
                  setState(() {
