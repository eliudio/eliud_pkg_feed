...
class MemberProfileCache implements MemberProfileRepository {

  final MemberProfileRepository reference;
  final Map<String?, MemberProfileModel?> fullCache = Map();

  MemberProfileCache(this.reference);
