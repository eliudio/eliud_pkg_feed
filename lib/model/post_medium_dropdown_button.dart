...
typedef PostMediumChanged(String? value);

class PostMediumDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final String? value;
  final PostMediumChanged? trigger;
  final bool? optional;

  PostMediumDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return PostMediumDropdownButtonWidgetState();
  }
}

class PostMediumDropdownButtonWidgetState extends State<PostMediumDropdownButtonWidget> {
  PostMediumListBloc? bloc;

  PostMediumDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<PostMediumListBloc>(context);
