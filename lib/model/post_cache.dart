...
class PostCache implements PostRepository {
  ...
  @override
  StreamSubscription<List<PostModel>> listen(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {
  ...
  @override
  StreamSubscription<List<PostModel>> listenWithDetails(trigger, {String currentMember, String orderBy, bool descending, bool isLoggedIn, int privilegeLevel}) {
