...
typedef HeaderChanged(String? value);

class HeaderDropdownButtonWidget extends StatefulWidget {
  final AppModel app;
  final String? value;
  final HeaderChanged? trigger;
  final bool? optional;

  HeaderDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return HeaderDropdownButtonWidgetState();
  }
}

class HeaderDropdownButtonWidgetState extends State<HeaderDropdownButtonWidget> {
  HeaderListBloc? bloc;

  HeaderDropdownButtonWidgetState();

  @override
  void didChangeDependencies() {
    bloc = BlocProvider.of<HeaderListBloc>(context);
...
List<Widget> widgets(HeaderModel value) {
var app = widget.app;
var widgets = <Widget>[];
