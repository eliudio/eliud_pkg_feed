...
typedef LabelledBodyComponentWidgetProvider(LabelledBodyComponentModel? value);

class LabelledBodyComponentListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  LabelledBodyComponentWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  LabelledBodyComponentListWidgetState? state;
  bool? isEmbedded;

  LabelledBodyComponentListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  LabelledBodyComponentListWidgetState createState() {
    state ??= LabelledBodyComponentListWidgetState();
    return state!;
  }
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: LabelledBodyComponentForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return LabelledBodyComponentListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return LabelledBodyComponentForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
