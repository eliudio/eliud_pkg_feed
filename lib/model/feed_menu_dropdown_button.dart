...
typedef FeedMenuChanged(String? value, int? privilegeLevel,);
...
class FeedMenuDropdownButtonWidget extends StatefulWidget {
  ...
  FeedMenuDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return FeedMenuDropdownButtonWidgetState();
  }
}

class FeedMenuDropdownButtonWidgetState extends State<FeedMenuDropdownButtonWidget> {
  FeedMenuListBloc? bloc;

  FeedMenuDropdownButtonWidgetState();
...
List<Widget> widgets(FeedMenuModel value) {
var app = widget.app;
var widgets = <Widget>[];
...
return widgets;
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<FeedMenuListBloc, FeedMenuListState>(builder: (context, state) {
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'feedMenus', widget.value, (newValue, _) {
                  setState(() {
