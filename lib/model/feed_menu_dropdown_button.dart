...
typedef FeedMenuChanged(String? value);
...
class FeedMenuDropdownButtonWidget extends StatefulWidget {
  ...
  FeedMenuDropdownButtonWidget({ required this.app, this.value, this.trigger, this.optional, Key? key }): super(key: key);
