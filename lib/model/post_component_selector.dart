...
class PostComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<PostListBloc>(
      ...
      child: SelectPostWidget(app: app,
          height: height,
...
class SelectPostWidget extends StatefulWidget {
  ...
  @override
  _SelectPostWidgetState createState() {
    return _SelectPostWidgetState();
  }
}

class _SelectPostWidgetState extends State<SelectPostWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<PostListBloc>(context).add(
            PostChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID)));
    }
  }
