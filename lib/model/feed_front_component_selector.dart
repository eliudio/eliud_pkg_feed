...
class FeedFrontComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<FeedFrontListBloc>(
          ...
          feedFrontRepository:
              feedFrontRepository(appId: appId)!,
          )..add(LoadFeedFrontList()),
      child: SelectFeedFrontWidget(app: app,
          height: height,
...
class SelectFeedFrontWidget extends StatefulWidget {
  ...
  @override
  _SelectFeedFrontWidgetState createState() {
    return _SelectFeedFrontWidgetState();
  }
}

class _SelectFeedFrontWidgetState extends State<SelectFeedFrontWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<FeedFrontListBloc>(context).add(
            FeedFrontChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
