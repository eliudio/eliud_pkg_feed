...
class PostCommentFirestore implements PostCommentRepository {
  Future<PostCommentModel> add(PostCommentModel value) {
    return PostCommentCollection.doc(value.documentID).set(value.toEntity(appId: appId).copyWith(timestamp : FieldValue.serverTimestamp(), ).toDocument()).then((_) => value).then((v) => get(value.documentID));
  }
  ...
  Future<PostCommentModel> update(PostCommentModel value) {
    return PostCommentCollection.doc(value.documentID).update(value.toEntity(appId: appId).copyWith(timestamp : FieldValue.serverTimestamp(), ).toDocument()).then((_) => value).then((v) => get(value.documentID));
  }
  ...
  Future<PostCommentModel> get(String id, {Function(Exception) onError}) {
    return PostCommentCollection.doc(id).get().then((doc) {
      if (doc.data() != null)
...
//    stream = getQuery(PostCommentCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots().map((data) {
...
//    In the meantime:
      stream = getQuery(appRepository().getSubCollection(appId, 'postcomment'), orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots().map((data) {
      Iterable<PostCommentModel> postComments  = data.docs.map((doc) {
        PostCommentModel value = _populateDoc(doc);
        return value;
      }).toList();
      return postComments;
    });
  ...
  StreamSubscription<List<PostCommentModel>> listenWithDetails(PostCommentModelTrigger trigger, {String orderBy, bool descending, Object startAfter, int limit, int privilegeLevel, EliudQuery eliudQuery}) {
    Stream<List<PostCommentModel>> stream;
//  stream = getQuery(PostCommentCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots()
//  see comment listen(...) above
    stream = getQuery(appRepository().getSubCollection(appId, 'postcomment'), orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots()
        .asyncMap((data) async {
  ...
  Stream<List<PostCommentModel>> values({String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    ...
    Stream<List<PostCommentModel>> _values = getQuery(PostCommentCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots().map((snapshot) {
  ...
  Stream<List<PostCommentModel>> valuesWithDetails({String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) {
    DocumentSnapshot lastDoc;
    Stream<List<PostCommentModel>> _values = getQuery(PostCommentCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).snapshots().asyncMap((snapshot) {
  ...
  Future<List<PostCommentModel>> valuesList({String orderBy, bool descending, Object startAfter, int limit, SetLastDoc setLastDoc, int privilegeLevel, EliudQuery eliudQuery }) async {
    DocumentSnapshot lastDoc;
    List<PostCommentModel> _values = await getQuery(PostCommentCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId).get().then((value) {
      var list = value.docs;
      return list.map((doc) { 
        lastDoc = doc;
        return _populateDoc(doc);
  ...
  Future<PostCommentModel> changeValue(String documentId, String fieldName, num changeByThisValue) {
    ...
    return PostCommentCollection.doc(documentId).update({fieldName: change}).then((v) => get(documentId));
  }
