...
import 'post_medium_form.dart';


typedef PostMediumWidgetProvider(PostMediumModel? value);

class PostMediumListWidget extends StatefulWidget with HasFab {
  AppModel app;
  BackgroundModel? listBackground;
  PostMediumWidgetProvider? widgetProvider;
  bool? readOnly;
  String? form;
  PostMediumListWidgetState? state;
  bool? isEmbedded;

  PostMediumListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);

  @override
  PostMediumListWidgetState createState() {
    state ??= PostMediumListWidgetState();
    return state!;
  }
...
class PostMediumListWidgetState extends State<PostMediumListWidget> {
  @override
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              value: BlocProvider.of<PostMediumListBloc>(context),
              child: PostMediumForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return PostMediumListItem(app: widget.app,
            value: value,
//            app: accessState.app,
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return PostMediumForm(app:widget.app, value: value, formAction: action);
    } else {
      return null;
    }
  }
...
class PostMediumListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      key: Key('__PostMedium_item_${value.documentID}'),
