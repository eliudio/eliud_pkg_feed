...
class PostMediumListWidget extends StatefulWidget with HasFab {
  ...
  PostMediumListWidget({ Key? key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
class PostMediumListWidgetState extends State<PostMediumListWidget> {
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return PostMediumForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
