    ...
    if (formAction == FormAction.ShowData) {
      ...
      return Scaffold(
        appBar: formAction == FormAction.UpdateAction ?
                AppBar(
                    title: Text("Update Header", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                  ) :
                AppBar(
                    title: Text("Add Header", style: TextStyle(color: RgbHelper.color(rgbo: app.formAppBarTextColor))),
                    flexibleSpace: Container(
                        decoration: BoxDecorationHelper.boxDecoration(accessState, app.formAppBarBackground)),
                ),
      ...
      if (state is HeaderFormInitialized) {
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is DocumentIDHeaderFormError ? state.message : null;
                  },
                ),
          );
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is AppIdHeaderFormError ? state.message : null;
                  },
                ),
          );
        ...
        children.add(
                ...
                style: TextStyle(color: RgbHelper.color(rgbo: app.formFieldTextColor)),
                  ...
                  autovalidate: true,
                  validator: (_) {
                    return state is DescriptionHeaderFormError ? state.message : null;
                  },
                ),
          );
