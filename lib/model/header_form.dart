...
class HeaderForm extends StatelessWidget {
  ...
  HeaderForm({Key? key, required this.app, required this.formAction, required this.value, this.submitAction}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (formAction == FormAction.ShowData) {
      return BlocProvider<HeaderFormBloc >(
        ...
        child: MyHeaderForm(app:app, submitAction: submitAction, formAction: formAction),
          );
      ...
      return Scaffold(
        appBar: StyleRegistry.registry().styleWithApp(app).adminFormStyle().appBarWithString(app, context, title: formAction == FormAction.UpdateAction ? 'Update Header' : 'Add Header'),
...
class MyHeaderForm extends StatefulWidget {
  ...
  MyHeaderForm({required this.app, this.formAction, this.submitAction});
