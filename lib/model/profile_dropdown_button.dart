...
typedef ProfileChanged(String? value);
...
class ProfileDropdownButtonWidget extends StatefulWidget {
  ...
  ProfileDropdownButtonWidget({ this.value, this.trigger, this.optional, Key? key }): super(key: key);
...
List<Widget> widgets(ProfileModel pm) {
var widgets = <Widget>[];
