...
typedef ProfileChanged(String? value, int? privilegeLevel,);
...
class ProfileDropdownButtonWidget extends StatefulWidget {
  ...
  ProfileDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ProfileDropdownButtonWidgetState();
  }
}

class ProfileDropdownButtonWidgetState extends State<ProfileDropdownButtonWidget> {
  ProfileListBloc? bloc;

  ProfileDropdownButtonWidgetState();
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'profiles', widget.value, (newValue, _) {
                  setState(() {
