...
class MemberProfileEntity {
  ...
  MemberProfileEntity({this.appId, this.profileBackgroundId, this.profileOverrideId, this.readAccess, });


  List<Object?> get props => [appId, profileBackgroundId, profileOverrideId, readAccess, ];

  @override
  String toString() {
    String readAccessCsv = (readAccess == null) ? '' : readAccess!.join(', ');

    return 'MemberProfileEntity{appId: $appId, profileBackgroundId: $profileBackgroundId, profileOverrideId: $profileOverrideId, readAccess: String[] { $readAccessCsv }}';
  }
