...
class PostAlbumFormError extends AlbumFormError { 
  const PostAlbumFormError({ String? message, AlbumModel? value }): super(message: message, value: value);
