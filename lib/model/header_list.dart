...
class HeaderListWidget extends StatefulWidget with HasFab {
  ...
  HeaderListWidget({ Key? key, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
...
class HeaderListWidgetState extends State<HeaderListWidget> {
  ...
  Widget? getForm(value, action) {
    if (widget.form == null) {
      return HeaderForm(value: value, formAction: action);
    } else {
      return null;
    }
  }
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      child: ListTile(
        onTap: onTap,
        title: Hero(
          tag: '${value!.documentID}__HeaderheroTag',
          child: Container(
