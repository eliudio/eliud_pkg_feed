...
class FeedMenuComponentSelector extends ComponentSelector {
  ...
  Widget createSelectWidget(BuildContext context, AppModel app, int privilegeLevel, double height,
    ...
    return BlocProvider<FeedMenuListBloc>(
      ...
      child: SelectFeedMenuWidget(app: app,
          height: height,
...
class SelectFeedMenuWidget extends StatefulWidget {
  ...
  @override
  _SelectFeedMenuWidgetState createState() {
    return _SelectFeedMenuWidgetState();
  }
}

class _SelectFeedMenuWidgetState extends State<SelectFeedMenuWidget> with TickerProviderStateMixin {
  ...
  void _handlePrivilegeTabSelection() {
    if ((_privilegeTabController != null) &&
        ...
        BlocProvider.of<FeedMenuListBloc>(context).add(
            FeedMenuChangeQuery(newQuery: getComponentSelectorQuery(_currentPrivilege, widget.app.documentID!)));
    }
  }
