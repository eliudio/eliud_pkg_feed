...
class FeedMenuListWidget extends StatefulWidget with HasFab {
  ...
  FeedMenuListWidget({ Key? key, required this.app, this.readOnly, this.form, this.widgetProvider, this.isEmbedded, this.listBackground }): super(key: key);
      ...
      onPressed: () {
        Navigator.of(context).push(
          pageRouteBuilder(widget.app, page: BlocProvider.value(
              ...
              child: FeedMenuForm(app:widget.app,
                  value: null,
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return FeedMenuListItem(app: widget.app,
            value: value,
//            app: accessState.app,
