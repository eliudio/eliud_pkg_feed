...
class FeedFrontFirestore implements FeedFrontRepository {
  @override
  FeedFrontEntity? fromMap(Object? o) {
    return FeedFrontEntity.fromMap(o);
  }
  ...
  Future<FeedFrontModel> update(FeedFrontModel value) {
    return FeedFrontCollection.doc(value.documentID).update(value.toEntity(appId: appId).toDocument()).then((_) => value);
  }

  Future<FeedFrontModel?> _populateDoc(DocumentSnapshot value) async {
    return FeedFrontModel.fromEntity(value.id, FeedFrontEntity.fromMap(value.data()));
  }
...
//  stream = getQuery(FeedFrontCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots()
  ...
  StreamSubscription<FeedFrontModel?> listenTo(String documentId, FeedFrontChanged changed) {
    var stream = FeedFrontCollection.doc(documentId)
        .snapshots()
        .asyncMap((data) {
  ...
  Stream<List<FeedFrontModel?>> values({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) {
    ...
    Stream<List<FeedFrontModel?>> _values = getQuery(FeedFrontCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?, limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.snapshots().asyncMap((snapshot) {
  ...
  Future<List<FeedFrontModel?>> valuesList({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) async {
    DocumentSnapshot? lastDoc;
    List<FeedFrontModel?> _values = await getQuery(FeedFrontCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.get().then((value) {
      var list = value.docs;
  ...
  Future<List<FeedFrontModel?>> valuesListWithDetails({String? orderBy, bool? descending, Object? startAfter, int? limit, SetLastDoc? setLastDoc, int? privilegeLevel, EliudQuery? eliudQuery }) async {
    DocumentSnapshot? lastDoc;
    List<FeedFrontModel?> _values = await getQuery(FeedFrontCollection, orderBy: orderBy,  descending: descending,  startAfter: startAfter as DocumentSnapshot?,  limit: limit, privilegeLevel: privilegeLevel, eliudQuery: eliudQuery, appId: appId)!.get().then((value) {
      var list = value.docs;
      return Future.wait(list.map((doc) {
  ...
  Future<FeedFrontModel?> changeValue(String documentId, String fieldName, num changeByThisValue) {
    ...
    return FeedFrontCollection.doc(documentId).update({fieldName: change}).then((v) => get(documentId));
  }


  final String appId;
  FeedFrontFirestore(this.getCollection, this.appId): FeedFrontCollection = getCollection();
