...
typedef PostCommentChanged(String? value, int? privilegeLevel,);
...
class PostCommentDropdownButtonWidget extends StatefulWidget {
  ...
  PostCommentDropdownButtonWidget({ required this.app, this.privilegeLevel, this.value, this.trigger, this.optional, Key? key }): super(key: key);
        ...
        return ListView(
          ...
          if (widget.value != null) 
            Align(alignment: Alignment.topRight, child: button(
              ...
              label: 'Update',
              onPressed: () {
                updateComponent(context, widget.app, 'postComments', widget.value, (newValue, _) {
                  setState(() {
