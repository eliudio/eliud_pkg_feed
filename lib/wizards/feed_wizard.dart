...
class FeedWizard extends NewAppWizardInfoWithActionSpecification {
  ...
  @override
  NewAppWizardParameters newAppWizardParameters() => ActionSpecificationParametersBase(requiresAccessToLocalFileSystem: false,
  ...
  @override
  MenuItemModel getThatMenuItem(AppModel app) => menuItemFeed(app, FEED_PAGE_ID, 'Feed');
